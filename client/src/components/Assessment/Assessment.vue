...
<script>
import assessment1 from "./Assessment1.vue";
import assessment2 from "./Assessment2.vue";
import assessment3 from "./Assessment3.vue";
  ...
  data() {
    return {
      ...
      tabs: [
        ...
        {id:"assessment2", namelang:"2. Ernährungsgewohnheiten/ 3.Verhalten und Umfeld", namekurz:"2./3."},
        {id:"assessment3", namelang:"4. Klinischer Status", namekurz:"4."}
      ]
    }
  },
  components: {
