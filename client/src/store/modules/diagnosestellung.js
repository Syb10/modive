  ...
  mutations:{
    ...
    getPASR(state,payload) {
      if(payload.ernaehrungsproblem != "" && payload.ursache != "" && payload.symptome != "" && payload.pRessourcen != "" && payload.nRessourcen != ""){
        ...
        payload.ernaehrungsproblem ? state.errorList[payload.index][0] = "" : state.errorList[payload.index][0] = "diätetisches Problem"
        payload.ursache ? state.errorList[payload.index][1] = "" : state.errorList[payload.index][1] = "Ätiologie/Ursache"
        payload.symptome ? state.errorList[payload.index][2] = "" : state.errorList[payload.index][2] = "Zeichen und Symptome"
